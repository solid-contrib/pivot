...
import type { GuardedWebIdStore } from '../../../src/identity/interaction/webid/util/GuardedWebIdStore';
...
describe('A ProfileCardGuard', (): void => {
  ...
  let webIdStore: { hasWebId: jest.Mock };
  ...
  beforeEach(async(): Promise<void> => {
    ...
    guard = new ProfileCardGuard(
      source,
      webIdStore as unknown as GuardedWebIdStore,
      ISSUER,
      converter as any,
      WEB_ID_PATHS,
    );
